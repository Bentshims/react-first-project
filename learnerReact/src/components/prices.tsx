        ...
        <>
            ...
            <div className="mx-auto max-w-3xl px-5 py-8 sm:px-6 sm:py-12 lg:px-8">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
                    <div
                    className="rounded-lg border border-indigo-600 p-6 shadow-xs ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12"
                    >
                    <div className="text-center">
                        ...
                        <p className="mb-10 mt-2 sm:mt-4">
                        <strong className="text-3xl font-bold text-indigo-400 sm:text-4xl"> $250 </strong>
                    ...
                    <ul className="mt-6 space-y-2">
                        ...
                        <svg
                            ...
                            strokeWidth="1.5"
                            stroke="currentColor"
                            className="size-5 text-indigo-500 shadow-sm"
                        >
                            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg>

                        <span className="text-gray-500"> 20 users included </span>
                        </li>
                        ...
                        <span className="text-gray-500"> 5GB of storage </span>
                        </li>
                        ...
                        <span className="text-gray-500"> Help center access </span>
                        </li>
